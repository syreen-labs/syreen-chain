...
type MsgBorrow struct {
	Sender           string   `json:"sender"`
	BorrowPoolID     uint64   `json:"borrow_pool_id"`
	Amount           math.Int `json:"amount"`
	CollateralPoolID uint64   `json:"collateral_pool_id"`
	CollateralAmount math.Int `json:"collateral_amount"`
}

func (m *MsgBorrow) ValidateBasic() error {
	if _, err := sdk.AccAddressFromBech32(m.Sender); err != nil { return err }
	if m.Amount.IsNil() || !m.Amount.IsPositive() { return ErrInvalidAmount }
	if m.CollateralAmount.IsNil() || !m.CollateralAmount.IsPositive() { return ErrInvalidAmount }
	return nil
}
...
type MsgRepay struct {
	...
	Amount   math.Int `json:"amount"` // 0 = repay all
}
...
type MsgCreateLendingPool struct {
	...
	CollateralFactor math.LegacyDec `json:"collateral_factor"`
...
// Response types
type MsgDepositResponse struct{ InterestEarned math.Int `json:"interest_earned"` }
func (m *MsgDepositResponse) ProtoMessage() {}; func (m *MsgDepositResponse) Reset() { *m = MsgDepositResponse{} }; func (m *MsgDepositResponse) String() string { return "MsgDepositResponse" }; func (m *MsgDepositResponse) XXX_MessageName() string { return "syreen.lending.MsgDepositResponse" }

type MsgWithdrawResponse struct{ InterestEarned math.Int `json:"interest_earned"` }
func (m *MsgWithdrawResponse) ProtoMessage() {}; func (m *MsgWithdrawResponse) Reset() { *m = MsgWithdrawResponse{} }; func (m *MsgWithdrawResponse) String() string { return "MsgWithdrawResponse" }; func (m *MsgWithdrawResponse) XXX_MessageName() string { return "syreen.lending.MsgWithdrawResponse" }

type MsgBorrowResponse struct{ BorrowID uint64 `json:"borrow_id"` }
func (m *MsgBorrowResponse) ProtoMessage() {}; func (m *MsgBorrowResponse) Reset() { *m = MsgBorrowResponse{} }; func (m *MsgBorrowResponse) String() string { return "MsgBorrowResponse" }; func (m *MsgBorrowResponse) XXX_MessageName() string { return "syreen.lending.MsgBorrowResponse" }

type MsgRepayResponse struct{ InterestPaid math.Int `json:"interest_paid"`; CollateralReturned math.Int `json:"collateral_returned"` }
func (m *MsgRepayResponse) ProtoMessage() {}; func (m *MsgRepayResponse) Reset() { *m = MsgRepayResponse{} }; func (m *MsgRepayResponse) String() string { return "MsgRepayResponse" }; func (m *MsgRepayResponse) XXX_MessageName() string { return "syreen.lending.MsgRepayResponse" }

type MsgLiquidateResponse struct{ CollateralSeized math.Int `json:"collateral_seized"`; DebtRepaid math.Int `json:"debt_repaid"` }
func (m *MsgLiquidateResponse) ProtoMessage() {}; func (m *MsgLiquidateResponse) Reset() { *m = MsgLiquidateResponse{} }; func (m *MsgLiquidateResponse) String() string { return "MsgLiquidateResponse" }; func (m *MsgLiquidateResponse) XXX_MessageName() string { return "syreen.lending.MsgLiquidateResponse" }

type MsgCreateLendingPoolResponse struct{ PoolID uint64 `json:"pool_id"` }
func (m *MsgCreateLendingPoolResponse) ProtoMessage() {}; func (m *MsgCreateLendingPoolResponse) Reset() { *m = MsgCreateLendingPoolResponse{} }; func (m *MsgCreateLendingPoolResponse) String() string { return "MsgCreateLendingPoolResponse" }; func (m *MsgCreateLendingPoolResponse) XXX_MessageName() string { return "syreen.lending.MsgCreateLendingPoolResponse" }
