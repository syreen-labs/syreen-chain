...
type MsgCreateVault struct {
	...
	PerformanceFee math.LegacyDec `json:"performance_fee"`
}
...
// Response types
type MsgCreateVaultResponse struct{ VaultID uint64 `json:"vault_id"` }
func (m *MsgCreateVaultResponse) ProtoMessage() {}; func (m *MsgCreateVaultResponse) Reset() { *m = MsgCreateVaultResponse{} }; func (m *MsgCreateVaultResponse) String() string { return "MsgCreateVaultResponse" }; func (m *MsgCreateVaultResponse) XXX_MessageName() string { return "syreen.vault.MsgCreateVaultResponse" }

type MsgDepositVaultResponse struct{ SharesMinted math.Int `json:"shares_minted"` }
func (m *MsgDepositVaultResponse) ProtoMessage() {}; func (m *MsgDepositVaultResponse) Reset() { *m = MsgDepositVaultResponse{} }; func (m *MsgDepositVaultResponse) String() string { return "MsgDepositVaultResponse" }; func (m *MsgDepositVaultResponse) XXX_MessageName() string { return "syreen.vault.MsgDepositVaultResponse" }

type MsgWithdrawVaultResponse struct{ AmountReturned math.Int `json:"amount_returned"` }
func (m *MsgWithdrawVaultResponse) ProtoMessage() {}; func (m *MsgWithdrawVaultResponse) Reset() { *m = MsgWithdrawVaultResponse{} }; func (m *MsgWithdrawVaultResponse) String() string { return "MsgWithdrawVaultResponse" }; func (m *MsgWithdrawVaultResponse) XXX_MessageName() string { return "syreen.vault.MsgWithdrawVaultResponse" }

type MsgCompoundVaultResponse struct{ YieldGenerated math.Int `json:"yield_generated"` }
func (m *MsgCompoundVaultResponse) ProtoMessage() {}; func (m *MsgCompoundVaultResponse) Reset() { *m = MsgCompoundVaultResponse{} }; func (m *MsgCompoundVaultResponse) String() string { return "MsgCompoundVaultResponse" }; func (m *MsgCompoundVaultResponse) XXX_MessageName() string { return "syreen.vault.MsgCompoundVaultResponse" }

type MsgUpdateVaultStrategyResponse struct{}
func (m *MsgUpdateVaultStrategyResponse) ProtoMessage() {}; func (m *MsgUpdateVaultStrategyResponse) Reset() { *m = MsgUpdateVaultStrategyResponse{} }; func (m *MsgUpdateVaultStrategyResponse) String() string { return "MsgUpdateVaultStrategyResponse" }; func (m *MsgUpdateVaultStrategyResponse) XXX_MessageName() string { return "syreen.vault.MsgUpdateVaultStrategyResponse" }
